...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.record} onPress={recording ? stopRecording : startRecording}>
        {recording ? 'Stop Recording' : 'Start Recording'}
      </Text>

      <View style={styles.savedItems}>{getRecordingLines()}</View>

      <Text style={styles.clear} onPress={clearRecordings}>
        Clear Recordings
      </Text>
    </View>
  );
